...
export default function AddToBasketButton({
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full z-50 bg-transparent px-4 py-3 flex justify-center">
      <button
        type="button"
        onClick={handleClick}
        disabled={disabled}
        className={`w-full max-w-md py-3 rounded-md text-white font-semibold transition ${
          disabled
